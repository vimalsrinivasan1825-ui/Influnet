...
| [CONFIDENCE_REPORT_2026-08-08.md](operations/CONFIDENCE_REPORT_2026-08-08.md) | **Read before a tester round.** Per-area confidence rating with the evidence behind each one (282/282 checks, web + mobile), and the three things that will make a new user struggle — none of them code bugs. |
| [FULL_FLOW_AUDIT_2026-08-08.md](operations/FULL_FLOW_AUDIT_2026-08-08.md) | The audit those fixes came from: 12 real personas driven through every flow with deliberate concurrency and abuse scenarios. Documents the checklist-gate money bypass and the sign-off race, both now fixed. |
